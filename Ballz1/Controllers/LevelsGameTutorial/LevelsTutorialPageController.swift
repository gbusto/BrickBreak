//
//  GameTutorialPageController.swift
//  Ballz1
//
...
class LevelsTutorialPageController: UIPageViewController, UIPageViewControllerDataSource {
    
    // Returns the view controllers in order for classic tutorial/onboarding
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        return [newLevelsTutorialViewController(storyboardId: "LevelsTutorialController1"),
                newLevelsTutorialViewController(storyboardId: "LevelsTutorialController2"),
                newLevelsTutorialViewController(storyboardId: "LevelsTutorialController3")
        ]
    }()
    
    // Returns the view controller with the specified storyboardID
    private func newLevelsTutorialViewController(storyboardId: String) -> UIViewController {
